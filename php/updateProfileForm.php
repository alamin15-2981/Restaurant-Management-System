<?php
    ...
    $id = $_REQUEST['id'];
    $selectQuery = "select * from customer_login where id = '$id'";
...
<html lang="en">
  ...
  <!-- position-absolute top-50 start-50 -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4 shadow shadow-sm rounded rounded-3 p-4 abs-center bg-dark text-light form-over">
                        ...
                        <form action="updateProfileQuery.php" method="post" enctype="multipart/form-data"> 
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="Phone" class="form-control" type="number" name="phone" value="<?php echo $data['phone'] ?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="">
                                <i class="fa-solid fa-calendar-days"></i>&nbsp;&nbsp;Birth Date
                                </label>
                                <input class="form-control" type="date" name="date" value="<?php echo $data['birthDate'] ?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="">
                                <i class="fa-solid fa-message"></i>&nbsp;&nbsp;About Me
                                </label>
                                <textarea class="form-control" name="message"  cols="40" rows="7" style="resize: none;" placeholder="About Me"><?php echo $data['message'] ?></textarea>
                            </div>
    ...
    <a href="../profile.php" class="btn btn-success top-btn-pos">Back</a>
