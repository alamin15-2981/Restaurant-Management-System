...
$selectQuery = "select * from admin_menu";
              ...
              <?php
                ...
                while($data = mysqli_fetch_assoc($selectRunQuery)){ ?>
                  <tr>
                    ...
                    <td><img src="uploads/<?php echo $data['photo']; ?>" alt="photo" style="width: 40px;height: 40px;border-radius: 50%;"></td>
                    <td><?php echo $data['price']; ?></td>
                    <td><?php echo $data['message']; ?></td>
                    <td><?php echo $data['localDateTime']; ?></td>
                    <td>
                      <a class="btn btn btn-danger" href="php/showMenuDataUpdateForm.php?id=<?php echo $data['id'] ?>">Update</a>
                      <a class="btn btn btn-danger" href="php/showMenuDataDelete.php?id=<?php echo $data['id'] ?>">Remove</a>
                    </td>
                  </tr>
              <?php  } ?>
            </tbody>
